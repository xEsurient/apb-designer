...
";| '_ ` _ \\ / _ \\ \\ /\\ / / '__/ _ \\\n" +
";| | | | | |  __/\\ V  V /| | |  __/\n" +
";|_| |_| |_|\\___| \\_/\\_(_)_|  \\___|Esurient (=^.^=)\n" +
";##########################################\n" +
...
"[WeaponItemTypes]\n\n";
    ...
    // Fetch detailed stats for all items in batches
    ...
    for (const item of detailedItems) {
      ...
      // Calculate APB Description Stats
      if (item.detail) {
        let wt = null;
          ...
          if (isExplosive) {
             ...
             if (stk > 0) {
                if (nBurstShots > 1 && fBurstInterval > 0) {
                    ...
                    topTtk = (stk - 1) * fFireInterval; // Standard fire rate TTK without burst delay
                } else {
        ...
        // Fallback for descriptions if present natively
